...
private:
    ...
    byte8 Signature;  // Идентификатор (всегда 89504E470D0A1A0A)
    ...
    struct Chunk{
        ...
        std::vector<byte1> Data; // Собственно данные, хранящиеся в блоке. Это поле может иметь нулевую длину, если не существует связанных с ним данных.
...
namespace TYPES{
    const byte4 IHDR = 0x49'48'44'52;
    const byte4 IDAT = 0x49'44'41'54;
    const byte4 IEND = 0x49'45'4e'44;
};